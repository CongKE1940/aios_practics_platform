...
const identityNameStyle: CSSProperties = { color: "var(--ui-color-ink)", fontSize: 14, lineHeight: 1.25, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" };
const identityMetaStyle: CSSProperties = { color: "var(--ui-color-text-muted)", fontSize: 12, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" };
const addressTextStyle: CSSProperties = { color: "var(--ui-color-text)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", display: "block", maxWidth: 420 };
const typePillStyle: CSSProperties = { display: "inline-flex", alignItems: "center", justifyContent: "center", minWidth: 54, padding: "4px 10px", borderRadius: 999, background: "var(--ui-color-primary-soft)", color: "var(--ui-color-primary-strong)", fontWeight: 700, fontSize: 12 };
const logoStyle: CSSProperties = { width: 42, height: 42, borderRadius: 8, objectFit: "cover", border: "1px solid var(--ui-color-border)", background: "var(--ui-color-bg-elevated)", flex: "0 0 auto" };
...
const dangerHintStyle: CSSProperties = { marginTop: 12, color: "var(--ui-color-danger)", fontWeight: 700 };
const modalShellStyle: CSSProperties = { width: "min(940px, calc(100vw - 48px))", maxHeight: "calc(100vh - 64px)", overflow: "auto" };
const editorCardStyle: CSSProperties = { display: "grid", gap: 0, borderRadius: 8, overflow: "hidden", background: "var(--ui-color-surface)", boxShadow: "var(--ui-shadow-card)", border: "1px solid var(--ui-color-border)" };
const editorHeroStyle: CSSProperties = { display: "flex", justifyContent: "space-between", gap: 24, alignItems: "flex-start", padding: "24px 26px", background: "var(--ui-color-primary-strong)", color: "#fffdf8" };
const editorEyebrowStyle: CSSProperties = { display: "inline-flex", marginBottom: 8, color: "var(--ui-color-accent-soft)", fontSize: 11, fontWeight: 800, letterSpacing: 0 };
const editorTitleStyle: CSSProperties = { margin: 0, fontSize: 24, lineHeight: 1.2, fontWeight: 800 };
const editorDescriptionStyle: CSSProperties = { margin: "8px 0 0", color: "rgba(255, 253, 248, 0.82)", fontSize: 13 };
const editorBodyStyle: CSSProperties = { display: "grid", gridTemplateColumns: "260px minmax(0, 1fr)", gap: 18, padding: 22, background: "var(--ui-color-bg)" };
const logoCardStyle: CSSProperties = { display: "grid", justifyItems: "center", alignContent: "start", gap: 12, padding: 20, borderRadius: 8, background: "var(--ui-color-surface)", border: "1px solid var(--ui-color-border)", boxShadow: "var(--ui-shadow-soft)" };
const logoCardLabelStyle: CSSProperties = { justifySelf: "start", color: "var(--ui-color-text-muted)", fontSize: 12, fontWeight: 800 };
const editorLogoStyle: CSSProperties = { width: 108, height: 108, borderRadius: 12, objectFit: "cover", border: "1px solid var(--ui-color-border)", background: "var(--ui-color-bg-elevated)" };
const previewNameStyle: CSSProperties = { maxWidth: "100%", color: "var(--ui-color-ink)", fontSize: 16, textAlign: "center", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" };
const previewTypeStyle: CSSProperties = { padding: "4px 10px", borderRadius: 999, background: "var(--ui-color-surface-soft)", color: "var(--ui-color-text-muted)", fontSize: 12, fontWeight: 700 };
const logoUploadFieldStyle: CSSProperties = { width: "100%", marginTop: 10 };
const formCardStyle: CSSProperties = { display: "grid", gap: 18, padding: 22, borderRadius: 8, background: "var(--ui-color-surface)", border: "1px solid var(--ui-color-border)", boxShadow: "var(--ui-shadow-soft)" };
const formSectionHeaderStyle: CSSProperties = { display: "grid", gap: 4, paddingBottom: 14, borderBottom: "1px solid var(--ui-color-border)", color: "var(--ui-color-ink)" };
const formSectionKickerStyle: CSSProperties = { color: "var(--ui-color-text-muted)", fontSize: 12, fontWeight: 800 };
const editorGridStyle: CSSProperties = { display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 16 };
const editorFooterStyle: CSSProperties = { display: "flex", justifyContent: "space-between", gap: 16, alignItems: "center", padding: "18px 22px", background: "var(--ui-color-surface)", borderTop: "1px solid var(--ui-color-border)" };
const editorFooterHintStyle: CSSProperties = { color: "var(--ui-color-text-muted)", fontSize: 12 };
